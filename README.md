...
> "Please run `npx -y @hybridlabor-api/bdb-dev-optimized-agent-skills@latest
```
*(This command works on Mac/Linux terminals as well as Windows PowerShell!)*@latest` to install the skills pack and configure the local MCP servers."
...
```
*(This command works on Mac/Linux terminals as well as Windows PowerShell!)*@latest
```
